...
void SharpeningFilter::ProcessPartition(const std::vector<uint8_t>& image_data,
                                          std::vector<uint8_t>& sharpening_data,
...
void SharpeningFilter::RunThreads(std::vector<uint8_t>& image_data, std::vector<uint8_t>& sharpening_data,
  ...
  for (int i = 0; i < num_threads; ++i) {
    ...
    threads.emplace_back(&SharpeningFilter::ProcessPartition, this,
                     std::ref(image_data), std::ref(sharpening_data), width, height, start_y, end_y);
