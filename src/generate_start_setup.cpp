...
Аргументы:
  ...
  -{имя фильтра}      Применяемый фильтр.
  ...
  Доступные фильтры:
                      ...
                      -threads <number>        Задать количество потоков.
                      -smooth <radius>         Сгладить изображение, усредняя соседние пиксели в окне размером.
...
Примечание:
  ...
  - Флаг -threads будет обработан в первую очередь и не зависит от порядка в строке.
